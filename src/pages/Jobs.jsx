        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
            ...
            <div className="flex flex-wrap gap-2 mb-5">
                {availableSources.map((src) => {
                    const sourceStyle = SOURCE_META[src] || SOURCE_META.All; // Get style for this source
                    const Icon = sourceStyle.icon;                            // Get icon for this source
                    ...
                    return (
                        <button
                            ...
                            className={`inline-flex items-center gap-1.5 rounded-xl px-4 py-2 text-sm font-medium border transition-all duration-200 ${
                                isActive
                                    ? sourceStyle.activeBg + " border-transparent"   // Active: gradient bg + no border
                                    : sourceStyle.bg + " hover:-translate-y-0.5"     // Inactive: outlined + hover lift
                            }`}
